...
const categoryColors = () => {
    ...
    switch (randomWord.category) {
        ...
        case 'arts':
            ...
            break;
        case 'body':
            colorDisplayCategoryIcon('#f56a37', 'block', 'Body', 'images/category-icons/category-icons-body.svg');
            break;
        case 'calendar':
            colorDisplayCategoryIcon('#cd5c5c', 'block', 'Calendar', 'images/category-icons/category-icons-calendar.svg');
            break;
        case 'catastrophe':
        ...
        case 'home':
            ...
            break;
        case 'nature':
            colorDisplayCategoryIcon('#2e8b57', 'block', 'Nature', 'images/category-icons/category-icons-nature.svg');
            break;
        case 'numbers':
            colorDisplayCategoryIcon('#6b6a9e', 'none', 'Numbers', 'images/category-icons/category-icons-numbers.svg');
            break;
        case 'people':
